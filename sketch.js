...
function setup() {
  ...
  vine_boom = loadSound('mixkit-arcade.wav');
  retro_game = loadSound('mixkit-crickets.wav');
  whoosh = loadSound('mixkit-dog.wav');
  acute_guitar = loadSound('mixkit-fast.wav');
  guitar_string = loadSound('small-sweep.wav');
  guitar_notif = loadSound('small-sweep.wav');
